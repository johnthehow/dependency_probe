...
def looper(epochs):
    ...
    probe_filename = f'PROBE[MODEL]{MODEL_NAME}[LAYER]{HIDDEN_LAYER}[DATA]{TRAIN_CONLL_PATH.stem}[RANK]{PROBE_RANK}[EPOCHS]{EPOCHS}[BATCHSIZE]{BATCH_SIZE}[LR]{LEARNING_RATE}[LOSSPOW]{PROBE_LOSS_POW}[DIRECTED]{str(DEPD_DIRECTED).lower()}.pth'
